# PTv3 semantic segmentation with a SONATA coord+opacity teacher.
# Ablation config: student keeps color+normal input, teacher uses coord+opacity only.
...
model = dict(
    ...
    teacher_backbone=dict(
        ...
        checkpoint_path="pre_trained/sonata_opacity_k20_400epoch_loss060.pth",
    ),
    mlp_bridge=dict(
...
sh_degree = 0
feat_teacher_keys = ("coord", "features")
