...
# model settings
model = dict(
    type="SegmentorBSDistillMattaport3d",
    num_classes=21,
    ...
    teacher_backbone=dict(
        ...
        checkpoint_path="exp/matterport3d/sonata_opacity_k20_400epoch_matterport3d_dl5/model/model_last.pth",
    ),
    mlp_bridge=dict(
...
# dataset settings
dataset_type = "MatterPort3DBSDistillDataset"
data_root = "data/matterport3d"

features_root = 'data/features/matterport3d_mah_k20'
boundary_root = 'data/boundary/matterport3d_scale07_bfa004'
