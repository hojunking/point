...
features_root = "data/features/matterport3d_mah_k20"  # 기본 features.npy 경로
dataset_type = "MatterPort3DDistillDataset"

data = dict(
    train=dict(
        type=dataset_type,      # 바로 ScanNetDataset을 지정
        split="train_grid1mm_chunk6x6_stride3x3",             # 사용할 데이터 스플릿을 "train"으로 지정
        data_root="data/matterport3d",  # 데이터 경로
        test_mode=False,
